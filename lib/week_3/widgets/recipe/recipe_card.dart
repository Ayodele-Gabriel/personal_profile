        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute<void>(
              builder:
                  (BuildContext context) => RecipeDetail(recipe: recipe),
            ),
          );
        },
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.all(12), child: _buildContent(context, isCompact: true)),
          ],
        ),
      ),
    );
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(image: AssetImage(recipe.imageUrl), fit: BoxFit.cover),
          ),
        ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 8),
            _buildInfoChip(icon: Icons.people, label: '${recipe.servings}', color: Colors.green),
            Spacer(),
            _buildRating(),
          ],
        ),

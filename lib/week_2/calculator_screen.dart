...
import 'package:personal_profile/week_2/utilities/calc_history.dart';
import 'package:personal_profile/week_2/utilities/calc_logic.dart';
import 'package:personal_profile/week_2/utilities/calc_state.dart';
import 'package:personal_profile/week_2/widgets/calculator_button.dart';
...
class _CalculatorScreenState extends State<CalculatorScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              _state.display,
              style: TextStyle(fontSize: _getDisplayFontSize(), fontWeight: FontWeight.w300),
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            color: isPressed ? Colors.black : button.color ?? _getDefaultButtonColor(button.type),
            child: Center(
              child: Text(
                button.text,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text("No calculations yet", style: TextStyle(color: Colors.grey, fontSize: 18)),
          ],
        ),
      );
    }
  ...
  void _useHistoryResult(String result) {
    ...
    if (value != null) {
      setState(() {
        _state = _state.copyWith(display: result, currentValue: value, shouldResetDisplay: true);
        _showHistory = false;
      });
    }
  }
